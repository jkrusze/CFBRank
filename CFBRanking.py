...
##################################################################################
    if option == 4:
        ...
        s_stats, aoyppa, aoypra, pts_p_r, pts_p_p = get_opp_adj_data(selected_team4)
        ...
        print('pts per rush yard: =',pts_p_r,'pts per pass yard =', pts_p_p)


##################################################################################

    if option == 5:
        selected_team51 = str(input('Enter Name of Team 1 :  '))
        s_stats1, aoyppa1, aoypra1, fra_att_r_1, fra_att_p_1,  pts_p_a1 = get_opp_adj_data(selected_team51)
        print('\n')
        print('##########################','\n')
        selected_team52 = str(input('Enter Name of Team 2 :  '))
        s_stats2, aoyppa2, aoypra2, fra_att_r_2, fra_att_p_2,  pts_p_a2 = get_opp_adj_data(selected_team52)
#
